package com.ffmpeg.myffmpeg.callback.worker;



import com.ffmpeg.myffmpeg.callback.EventCallBack;
import com.ffmpeg.myffmpeg.callback.EventCallBackType;
import com.ffmpeg.myffmpeg.data.CommandTasker;
import com.ffmpeg.myffmpeg.data.TaskerEventMsg;
		...
		for (;;) {
			try {
				while (queue.peek() != null) {
					...
					// 借助网络库发送该消息
					String url = CommandManagerI.config.getCallback();
					if (reqGET(url)) {
