...
import com.ffmpeg.myffmpeg.config.ProgramConfig;
import com.ffmpeg.myffmpeg.data.CommandTasker;
import com.ffmpeg.myffmpeg.data.TaskDao;
import com.ffmpeg.myffmpeg.handler.TaskHandler;

import java.util.Collection;
import java.util.Map;

import static com.ffmpeg.myffmpeg.util.PropertiesUtil.load;
 ...
 * @version 2016年10月29日
 */
public interface CommandManagerI {

	public static final ProgramConfig config=load("ffmpeg.properties", ProgramConfig.class);
	/**
	 * 注入自己实现的持久层
	 * 
	 * @param taskDao
	...
	* 返回整个对象
	* */
	public CommandTasker starts(String id, String commond, boolean hasPath);
